# externs/zellij.nu
# Adapted from zellij-completions.nu from nu_script
...
# zellij action
export alias "zlj ac" = zellij action
# zellij attach
export alias "zlj a" = zellij attach
# zellij edit
export alias "zlj e" = zellij edit
# zellij kill-session
export alias "zlj k" = zellij kill-session
# zellij kill-all-sessions
export alias "zlj ka" = zellij kill-all-sessions
# zellij run
export alias "zlj r" = zellij run #"w
# zellij action rename-tab
export alias "zlj art" = zellij action rename-tab
