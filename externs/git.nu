# Separated from original Nushell Config File
...
export alias gclon = git clone

export alias gadd  = git add

export alias gdiff = git diff
export alias glog  = git log
export alias gstat = git status

export alias gcom  = git commit
export alias gtag  = git tag

export alias gpush = git push
